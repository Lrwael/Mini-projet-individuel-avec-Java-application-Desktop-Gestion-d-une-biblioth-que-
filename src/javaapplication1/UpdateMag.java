 ...
 * @author waels
 */
public class UpdateMag extends javax.swing.JFrame {
    Connection con;
    ...
    /**
     * Creates new form UpdateMag
     */
    public UpdateMag(String b,String e,String n,String pu,String pr) {
        super("Update Magazine");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 153), 2, true), "Update Magazine", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 36), new java.awt.Color(0, 204, 204))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon("C:\\Users\\waels\\Downloads\\magazine.png")); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(68, 68, 68)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(pubb, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(tn, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Update Magasin");

        setSize(new java.awt.Dimension(488, 470));
...
try{
            String sql ="UPDATE magazine SET name=?,publisher=? WHERE doc_ID=?;";
       ...
       pubb.setText(sql);
        sql ="UPDATE document SET edition=?,price=? WHERE doc_ID=?;";
            ...
            ps.setString(3,docid.getText());
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null, "Magazine has been Updated .", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateMag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateMag(bid,edition,name,pub,price).setVisible(true);
            }
        });
    }
